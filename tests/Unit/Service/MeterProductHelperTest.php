...
final class MeterProductHelperTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->helper = new MeterProductHelper($this->productRepository, $this->metrics);
    }
    ...
    {
        $steps = MeterProductHelper::ROUNDING_STEPS;
        ...
        $this->assertSame(0, $steps[DynamicPriceConstants::ROUNDING_NONE]);
