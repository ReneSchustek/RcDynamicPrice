...
final class RcDynamicPriceConfigStructTest extends TestCase
{
    ...
    public function testRoundingStepsDefaultsToEmptyArray(): void
    {
        ...
        $this->assertSame([], $struct->getRoundingSteps());
    }

    public function testRoundingStepsRoundtrip(): void
    {
        $steps = ['none' => 0, 'cm' => 10, 'half_m' => 500];
        ...
        $this->assertSame($steps, $struct->getRoundingSteps());
    }
}
