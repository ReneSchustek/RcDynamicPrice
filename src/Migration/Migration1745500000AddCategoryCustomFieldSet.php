        ...
        return [
            ...
            DynamicPriceConstants::CAT_FIELD_MIN_LENGTH => [
                ...
                'config' => [
                    ...
                    'helpText' => [
                        'de-DE' => 'Mindestlänge für alle Produkte dieser Kategorie, sofern am Produkt nichts gesetzt ist.',
            ...
            DynamicPriceConstants::CAT_FIELD_MAX_LENGTH => [
                ...
                'config' => [
                    ...
                    'helpText' => [
                        'de-DE' => 'Maximallänge für alle Produkte dieser Kategorie, sofern am Produkt nichts gesetzt ist.',
            ...
            DynamicPriceConstants::CAT_FIELD_ROUNDING => [
                ...
                'config' => [
                    ...
                    'helpText' => [
                        'de-DE' => 'Aufrundung der Kundenlänge auf volle Einheiten.',
            ...
            DynamicPriceConstants::CAT_FIELD_SPLIT_MODE => [
                ...
                'config' => [
                    ...
                    'helpText' => [
                        'de-DE' => 'Behandlung langer Eingaben oberhalb der Teilstücklänge.',
            ...
            DynamicPriceConstants::CAT_FIELD_MAX_PIECE_LENGTH => [
                'type' => 'int',
                'config' => [
                    'label' => ['de-DE' => 'Max. Teilstücklänge (mm)', 'en-GB' => 'Max. piece length (mm)'],
                    'helpText' => [
                        'de-DE' => 'Ab welcher Länge greift das Splitting. Leer = kein Splitting.',
            ...
            DynamicPriceConstants::CAT_FIELD_SPLIT_HINT => [
                'type' => 'text',
                'config' => [
                    'label' => ['de-DE' => 'Hinweistext für Splitting', 'en-GB' => 'Hint text for splitting'],
                    'helpText' => [
