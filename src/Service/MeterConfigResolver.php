...
final class MeterConfigResolver implements MeterConfigResolverInterface
{
    ...
    public function resolve(array $productFields, array $categoryChain, string $salesChannelId): ResolvedMeterConfig
    {
        ...
        [$equalSplitBilling, $equalSplitEnforceMin] = $this->resolveEqualBilling($salesChannelId);
        ...
        return new ResolvedMeterConfig(
            ...
            equalSplitBilling: $equalSplitBilling,
     ...
     */
    private function resolveEqualBilling(string $salesChannelId): array
    {
        $billing = $this->systemConfigService->getString(
            DynamicPriceConstants::CONFIG_EQUAL_BILLING,
            $salesChannelId,
        );
        if ($billing !== DynamicPriceConstants::EQUAL_BILLING_EXACT) {
